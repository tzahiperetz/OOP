 ...
 * e1,e2 are the Expressions that Division will be apllied on
 * n1,n2 are the Numbers that Division will be apllied on
...
public class Division extends Expression {
	 ...
	 */
	public Division(Expression e1 ,Expression e2) throws ArithmeticException {		
	 ...
	 */
	public Division(Expression e1 ,Number n2) throws ArithmeticException {	
	 ...
	 */
	public Division(Number n1 ,Expression e2) throws ArithmeticException {		
	 ...
	 * @param n2 - second given number
	 */
	public Division(Number n1, Number n2) throws ArithmeticException {
	...
	public void checkRep() {
		...
		if (n2 != null ) {
			assert (n2.doubleValue() == 0.0 ) : "n2 is 0 " ; 
			assert !(n2 instanceof Number) : "Wrong type of n2 ";
		}
		if (e2 != null ) { 
			assert ( e2.eval().doubleValue() == 0.0 ) : "e2 is 0 " ; 
	...
	/**
	 * @return String of " first arguments / second argument " 
	 */
	@Override
