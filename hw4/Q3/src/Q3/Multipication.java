package Q3;
/**
 * implements Multipication operation
 * given 2 expressions ,a and b , this class will return result of a*b 
 * 
 * Abstraction Function :
 * e1,e2 are the Expressions that Multipication will be apllied on
 * n1,n2 are the Numbers that Multipication will be apllied on
 ...
 */
public class Multipication extends Expression {
	 ...
	 */
	public Multipication(Expression e1 ,Expression e2)  {		
	 ...
	 */
	public Multipication(Expression e1 ,Number n2) {	
	 ...
	 */
	public Multipication(Number n1 ,Expression e2)  {		
	 ...
	 * @param n2 - second given number
	 */
	public Multipication(Number n1, Number n2) {
