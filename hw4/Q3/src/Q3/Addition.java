 ...
 * e1,e2 are the Expressions that Addition will be apllied on
 * n1,n2 are the Numbers that Addition will be apllied on
...
public class Addition extends Expression {
	 ...
	 */
	public Addition(Expression e1 ,Number n2) {	
	 ...
	 */
	public Addition(Number n1 ,Expression e2)  {		
	 ...
	 * @param n2 - second given number
	 */
	public Addition(Number n1, Number n2) {
